...
OUTPUT_BASE_DIR = "/home/yuan/Yuan/OIL_Project_12_7/dataset/DV4_SAR_Small_v3_relabel_TransferPaperRGB_Fix_Patch"
CATEGORIES = ["DV4_SAR_Small_v3_relabel_TransferPaperRGB_Fix"]
...
OVERLAP_TRAIN_VAL = 112 # stride = PATCH_SIZE - OVERLAP_TRAIN_VAL

# 2. Test: 針對"整張圖"使用此重疊量 (標準滑動窗口)。
#    建議設大一點 (例如 256 或 512) 以獲得更好的重建 (Reconstruction) 效果，減少接縫感。
OVERLAP_TEST = 112        # stride = PATCH_SIZE - OVERLAP_TEST
